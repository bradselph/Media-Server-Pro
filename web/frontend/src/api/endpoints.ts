...
export const adminApi = {
    ...
    getEventsByMedia: (mediaId: string, limit?: number) => {
        // TODO: The comment below is stale — it references the pre-UUID MD5 era. The backend
        // now expects a stable UUID (MediaItem.id generated by internal/media/discovery.go using
        // uuid.New()). The MD5-of-path scheme was removed in the v0.32.0 opaque receiver ID
        // refactor. Update callers and this comment to reflect that a plain UUID string is expected.
