  ...
  <div v-else-if="items.length > 0" class="space-y-3">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center gap-2">
        <NuxtLink v-if="to" :to="to"
                  class="text-xs font-medium text-[var(--accent-soft)] hover:underline flex items-center gap-1">See all
    ...
    <div ref="scrollContainer" class="flex gap-3 overflow-x-auto pb-3 scroll-smooth scrollbar-hide">
      ...
      >
        ...
        <p class="text-xs font-semibold truncate group-hover:text-primary transition-colors"
           :title="getDisplayTitle(s)">{{ getDisplayTitle(s) }}</p>
