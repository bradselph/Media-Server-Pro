        ...
        <div class="pt-3">
          ...
          <div v-if="item.value === 'stats' && stats" class="space-y-4">
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <UCard v-for="item in [
          { label: 'Blocked (since restart)', value: stats.total_blocks_today, icon: 'i-lucide-shield-x' },
          { label: 'Rate Limited (since restart)', value: stats.total_rate_limited, icon: 'i-lucide-gauge' },
