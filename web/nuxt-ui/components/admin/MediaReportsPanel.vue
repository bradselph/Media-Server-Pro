...
function reasonLabel(reason: string): string {
  switch (reason) {
    ...
    case 'broken': return 'Broken / unplayable'
    ...
    <div class="flex items-center justify-between gap-3 flex-wrap">
      ...
      <div class="flex items-center gap-2">
        <USelect
          ...
          class="w-32"
        />
        <UButton icon="i-lucide-refresh-cw" label="Refresh" variant="outline" color="neutral" size="xs" @click="load(true)" />
      </div>
    </div>
